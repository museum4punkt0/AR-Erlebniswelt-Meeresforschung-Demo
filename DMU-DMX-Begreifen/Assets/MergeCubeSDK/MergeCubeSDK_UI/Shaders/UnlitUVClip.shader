...
Shader "Shader Forge/UnlitUVClip" {
    ...
    SubShader {
        ...
        Pass {
            ...
            //Commenting out cause this actually limits which platforms it compiles for. We don't really want that, it should use the default of compile for all.
