...
namespace MergeCube
{
	...
	public class CubeOrientation : MonoBehaviour 
		...
		private static Vector3 [] checkPoints = new [] {  new Vector3(0f,0f,-0.1f), new Vector3(-0.1f,0f,0f), new Vector3(0f,0f,0.1f),
			new Vector3(0.1f,0f,0f), new Vector3(0f,0.1f,0f), new Vector3(0f,-0.1f,0f) };


		private static bool SetRotation(int combo, Transform toSet)
			{
