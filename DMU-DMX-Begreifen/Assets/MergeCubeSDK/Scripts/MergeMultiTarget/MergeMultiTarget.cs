...
public class MergeMultiTarget : MonoBehaviour{
	public static MergeMultiTarget s_ins;
	...
	private List<MergeTrackableEventHandler> mergeTrackables = new List<MergeTrackableEventHandler>();
	private List<MergeTrackableEventHandler> trackers = new List<MergeTrackableEventHandler>();
	...
	private void MergeTrackingFoundHandler(){
		isTracking = true;
	...
	private void MergeTrackingLostHandler(){
		isTracking = false;
	...
	private void VuforiaTrackingEventHandle(bool isTracking){
	...
	private void KillReferenceCube(){
