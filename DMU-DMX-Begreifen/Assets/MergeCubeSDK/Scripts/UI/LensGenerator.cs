...
//			}
//
//			Debug.Log( "\n\n\nActual Screen Size = " + MergeUtility.GetActualLadscapeScreenSize() + " adjustment = " + adjustment );
//
//
			float posX = 0;
			if ( index == 0 )
...
//			Debug.Log( eye.name + " positionX = " + posX + " positionY = " + position.y + "\n\n\n" );
			...
			eyeMesh.transform.localPosition = new Vector3( posX, 0f );
	...
	private Vector2 ApplyDistortion(Vector2 originalPosition)
	{
