...
public class iVidCapPro : MonoBehaviour {
	...
	private int finalNumberDroppedFrames;
	...
	private float frameThrottleDelay;
	...
	private bool useCustomRT;
	
	// The session error delegate variable.
	private SessionErrorDelegate sessionErrorDelegate;
	
	// The video recording complete delegate variable.
	private SessionCompleteDelegate sessionCompleteDelegate;
	
	// Debug
	private bool showDebug;
	
	// Are we currently streaming audio to the wave file writer?
	private bool isAudioStreaming;
